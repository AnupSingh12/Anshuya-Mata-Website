...
const sacredSites = [
  {
    ...
    desc: "Behind the Ansuya Ashram temple, stone idols of various forest deities are enshrined. These deities are reverently worshipped every day during the morning and evening rituals.",
    img: vanDeviDevta,
  },
  {
    title: "Kshetrapal",
    desc: "As the guardian deity (Kshetrapal) of Ansuya Ashram, the valiant deity Amdar Devta, a foremost attendant of Mata Ansuya, is revered. His shrine is located near the ashram. He is not only considered the guardian deity of the ashram but is also worshipped as the protector of the entire Mandal valley.",
    img: chetrapal,
  },
  {
    title: "Shiv Parvati",
    desc: "At the rear section of the Ansuya Temple stands a stone idol of Lord Shiva and Goddess Parvati, and just behind it is a sacred Shivling that is worshipped daily.",
    img: shivParvati,
  },
  {
    title: "Dattatreya Linga",
    desc: "Lord Dattatreya is enshrined in lingam form behind the Ansuya Temple and is worshipped with daily rituals. Devotees from Maharashtra and other regions visit throughout the year to have his darshan and offer their reverence.",
    img: dattatreLing,
  },
  {
  ...
  },
  {
    ...
    desc: "Approximately 500 meters from the Ansuya Temple, along the pilgrimage route, stands a majestic idol of Lord Ganesha, revered as 'Chauri ke Ganesh'. As the first deity to be worshipped, devotees offer their prayers here before proceeding to seek the blessings of Mata Ansuya.",
    img: chauriKaGanesh,
  },
  {
    title: "Bhairav Nath",
  ...
  {
    title: "Kumkum Tree",
    desc: "Along the path from the ashram to the hermitage of Sage Atri stands a rare Kumkum tree, known to only a few. In Sanatan Dharma, the Kumkum tree holds great spiritual significance and is regarded as deeply sacred.",
    img: kumkumTree,
  },
  {
  ...
  },
  {
    ...
    desc: "Approximately 1.5 kilometers from Ansuya Ashram lies the hermitage of Sage Atri, graced by a breathtaking and serene waterfall. Devotees perform a sacred circumambulation (parikrama) around this divine cascade.",
    img: atriWaterFall,
  },
];
...
function NearBySites() {
  ...
  return (
    <div className="WholeBody">
        ...
        <div className="background-overlay">
          <div className="container py-5 text-white">
            ...
            <p className="text-center mb-5" data-aos="fade-up">
              Several religious and scenic attractions exist within and around
              the Ansuya Temple.
            </p>
      ...
      <div className="background-overlay">
        <NavigationButtons
          prevLink="/IntroductionPageEnglish"
          prevText="Introduction Page"
          nextLink="/TempleAdministrationEnglish"
          nextText="Temple Administration"
        />
      </div>
