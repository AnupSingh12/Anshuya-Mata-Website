    ...
    return(
        <div>
          <div>
            ...
            <p>The Ansuya Temple Management Committee comprises representatives from nine surrounding villages. It functions under the name Shri Ansuya Mandir Trust Committee. The term of the committee is five years, and each village sends one member.
               The Chairperson is elected in a general body meeting. From among the elected members, a Secretary and Treasurer are appointed. The roles and responsibilities are clearly defined in the trust's bylaws. Every year, the committee holds four general meetings to discuss all matters and festival planning</p>
        </div>
    )
}
