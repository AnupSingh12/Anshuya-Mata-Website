    ...
    <div>
      ...
      <div className="donation-new-hero">
        ...
        <p className="donation-new-message">
          श्री अनसूया मंदिर को सहयोग देने की आपकी इच्छा के लिए हम आपके बहुत आभारी हैं। <br />
          आपका दान हमें पवित्र परंपराओं को संरक्षित करने, भक्तों की सेवा करने और हमारे मंदिर की शांति और भावना को बनाए रखने में मदद करता है। <br />
